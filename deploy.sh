...
# Node List
PRE_LIST="192.168.1.11"
GROUP1_LIST="192.168.1.12"
ROLLBACK_LIST="192.168.1.11 192.168.1.12"
...
group1_deploy(){
	...
	scp ${CONFIG_DIR}/other/192.168.1.12.crontab.xml 192.168.1.12:/opt/webroot/${PKG_NAME}/crontab.xml

}

group1_test(){
	url_test "http://192.168.1.12/index.html"
	echo "add to cluster"
}
